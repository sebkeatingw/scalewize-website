...
function SignupPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            // Create user account
            const { data: authData, error: authError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.signUp({
    ...
    const createOrganizationAndProfile = async (userId)=>{
        try {
            // Create organization first
            const { data: orgData, error: orgError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('organizations').insert({
            ...
            // Create user profile
            const { error: profileError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('profiles').insert({
                id: userId,
                email: formData.email,
                full_name: formData.fullName,
...
_s(SignupPage, "/eAid3j1JFSEqDw2kqok6ejKhnk=", false, function() {
    return [
...
//# sourceMappingURL=src_995afaa1._.js.map